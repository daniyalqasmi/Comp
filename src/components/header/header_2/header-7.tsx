    ...
    return (
        <div><div className="navbar bg-myblack">
            <div className="navbar-start">
                ...
                <Link href={"#"} ><Image src={'/assest/logo.png'} alt="logo" width={100} height={100} className="p-2 hidden lg:block" /></Link>
            </div>
            <div className="navbar-center ">
                <Link href={"#"} ><Image src={'/assest/logo.png'} alt="logo" width={100} height={100} className=" block lg:hidden" /></Link>
